...
const OntoIcon = () => {
  return (
    <>
      <Box>
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 288 288" width="50px" >
      ...
      <Text fontSize='md' fontWeight={600} py={2}>Onto</Text>
    </>
  )
}
export default OntoIcon;